...
public class CustomExceptionHandler {
	...
	public ResponseEntity<Response> infoMessageHandler(InfoMessage ex, WebRequest request) {
		ex.printStackTrace();
		return new ResponseEntity<Response>(new Response(ex.getLocalizedMessage()), HttpStatus.OK);
	}
}
